...
def execute(context):
    ...
    df_population = context.stage("synthesis_thailand.population.sampled")[[
        "person_id", "household_id",
        "age", "sex", "employed", "studies",
        "number_of_vehicles", "household_size", "has_license", "income",
    ]]
    ...
    df_population = pd.merge(df_population, df_hts_persons[[
        "hts_id", "hts_household_id","is_passenger"
    ]], on = "hts_id")
