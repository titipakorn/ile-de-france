...
def configure(context):
    ...
    #     context.stage("synthesis_thailand.vehicles.selected")
...
def execute(context):
    ...
    # Prepare households
    df_households = context.stage("synthesis_thailand.population.enriched").rename(
    ...
    # Prepare persons
    df_persons = context.stage("synthesis_thailand.population.enriched").rename(
    ...
    # Prepare activities
    df_activities = context.stage("synthesis_thailand.population.activities").rename(
    ...
    # Prepare trips
    df_trips = context.stage("synthesis_thailand.population.trips").rename(
        columns = {
    ...
    #     # Prepare vehicles
    #     df_vehicle_types, df_vehicles = context.stage("synthesis_thailand.vehicles.selected")
    ...
    df_spatial = gpd.GeoDataFrame(df_activities, crs = 32647)
    ...
    df_spatial["geometry"] = [
        geo.LineString(od) if od[0]!=None and od[1]!=None else None
    ...
    df_spatial = gpd.GeoDataFrame(df_spatial, crs = 32647)
