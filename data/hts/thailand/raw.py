...
def validate(context):
    for name in ("thailand_hts/Trip.csv","thailand_hts/Household.csv","thailand_hts/Person.csv"):
    ...
    return [
        ...
        os.path.getsize("%s/thailand_hts/Household.csv" % context.config("data_path")),
