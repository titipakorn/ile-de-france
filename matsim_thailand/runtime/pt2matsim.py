...
import matsim_thailand.runtime.git as git
...
def configure(context):
    ...
    context.stage("matsim_thailand.runtime.maven")
...
def run(context, command, arguments, vm_arguments=[]):
    ...
    context.stage("matsim_thailand.runtime.pt2matsim")

    jar_path = "%s/pt2matsim/target/pt2matsim-%s-shaded.jar" % (
        context.path("matsim_thailand.runtime.pt2matsim"), version
    )
